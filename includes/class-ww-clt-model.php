...
class Ww_Clt_Model{
	...
	public function ww_clt_get_products($args=array()) {
		...
		$query_args = array( 'post_type' => WW_CLT_POST_TYPE, 'post_status' => 'publish');
	...
	public function ww_clt_text_from_value_status($value) {
		...
		switch ($value) {
			...
			case '0'	:	return __('Pending','wwclt');
			case '1'	:	return __('Approved','wwclt');
			case '2'	:	return __('Cancelled','wwclt');
			default		:	return __('Pending','wwclt');
		}
	}
